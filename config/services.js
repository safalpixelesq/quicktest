  ...
  ally: {
    ...
    */
    facebook: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/auth/authenticated/facebook`
    },
    ...
    */
    google: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/auth/authenticated/google`
    },
    ...
    */
    github: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/auth/authenticated/github`
    },
    ...
    twitter: {
		...
		redirectUri: `${Env.get('APP_URL')}/api/auth/authenticated/twitter`
	  },
    /*
     |--------------------------------------------------------------------------
